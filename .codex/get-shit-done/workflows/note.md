...
- **Global scope**: `/Users/kabdallreda/Desktop/lumen-layer/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kabdallreda/Desktop/lumen-layer/.codex/notes/`)
...
2. Glob `/Users/kabdallreda/Desktop/lumen-layer/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kabdallreda/Desktop/lumen-layer/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kabdallreda/Desktop/lumen-layer/.codex/notes/` — works in any directory
